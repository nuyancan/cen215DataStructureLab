...
int main()
{
    ...
    int IDX[] = {2, 0, 1, 8, 5, 5, 6, 4, 5, 7};
    char namex[] = "can nuyan";
    ...
    int IDY[] = {2, 0, 1, 8, 5, 5, 6, 4, 5, 7};
    char namey[] = "can nuyan";
    ...
    int IDZ[] = {2, 0, 1, 8, 5, 5, 6, 4, 5, 7};
    char namez[] = "can nuyan";
